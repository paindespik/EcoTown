...
def run_quiz(questions):
     ...
     for question in questions:
          ...
          if answer == question.answer:
               ...
               time.sleep(10)
     print("Tu as eu", score, "réponses correctes sur ", len(questions))
