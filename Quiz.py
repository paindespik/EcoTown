...
def Prompt(questioninput):
          switcher = {
             ...
             4: question_prompts[4],
             }
          return switcher.get(i,"Aucune question pour ce chiffre")
     
def FindQuestionVerifier(question):
     switcher = {
          1: QuestionVerifier(1)
          2: QuestionVerifier(2)
          3: QuestionVerifier(3)
          4: QuestionVerifier(4)
     }
def QuestionVerifier(question,answer):
     if question.answer == answer{
          Score(Score)
          print(question.explanation)
     }else{
     print("Faux ", question.explanation)
     }
